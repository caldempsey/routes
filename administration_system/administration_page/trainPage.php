		  ...
		  <div class="col-md-10">
	  			<div class="row">
		  			...
		  			<?php 	  			
						...
						$QueryResults_trains = $database->query("SELECT Trains.id,RailwayLines.name from Trains,RailwayLines 
							where Trains.railwaylines_id=RailwayLines.id");
						//Returns each row in its own array and those results are in an array, so [[]]
						$trainsArray = $QueryResults_trains->fetchAll(PDO::FETCH_NUM);	
					...
					?>	  				
	  				...
	  				<div class="col-md-6">												
							<div class="content-box-large">
			  				<div class="panel-heading">
								<div class="panel-title">Remove Train</div>
							</div>
			  				<div class="panel-body">			  							  				
			  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
									...
									<tbody>
										<?php  foreach ($trainsArray as $row): ?>
										<form action="deleteTrain.php" method="post">										
											<tr>
												<td>
												...
												onclick ="return confirm('This will remove all information related to this train (schedules). Please confirm this operation.')">
												</td>
											</tr>
										</form>
										<?php endforeach; ?>
